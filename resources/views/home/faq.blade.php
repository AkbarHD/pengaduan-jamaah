                ...
                @php
                    $faqs = [
                        [
                            ...
                            'answer' =>
                                'Isi formulir pengaduan tanpa perlu membuat akun. Setelah dikirim, Anda akan mendapatkan nomor pengaduan.',
                        ],
                        [
                            'question' => 'Apakah saya bisa melaporkan orang lain?',
                            'answer' =>
                                'Ya. Pilih opsi mewakili orang lain, lalu isi nama dan hubungan Anda dengan orang tersebut.',
                        ],
                        [
                            'question' => 'Apa yang harus dilakukan jika kondisi darurat?',
                            'answer' =>
                                'Pilih opsi "Darurat" saat membuat pengaduan. Setelah dikirim, Anda akan diarahkan untuk menghubungi KJRI melalui WhatsApp.',
                        ],
                        [
                            'question' => 'Bagaimana cara mengecek pengaduan?',
                            'answer' =>
                                'Gunakan menu "Cek Status Pengaduan" dengan memasukkan nomor pengaduan dan nomor WhatsApp.',
                        ],
                        [
                            'question' => 'Apa arti status pengaduan?',
                            'answer' =>
                                'Pending berarti menunggu pemeriksaan, Verifikasi berarti sedang diperiksa, Selesai berarti telah selesai diproses, dan Batal berarti pengaduan tidak dilanjutkan.',
                        ],
                        [
                            'question' => 'Apakah saya akan dihubungi setelah membuat pengaduan?',
                            'answer' =>
                                'Jika diperlukan, petugas dapat menghubungi pelapor melalui nomor WhatsApp yang diberikan.',
                        ],
                        [

...
@section('content')
    ...
    <div class="hero-image-frame">
        <div class="hero-image-wrapper">
            <img src="{{ asset('img/logo/hero-section.jpeg') }}" alt="Layanan Jamaah Haji dan Umroh">
        </div>
    ...
    <section class="section">
        <div class="container">
            <x-section-heading
                ...
                title="Apa yang Sedang Anda Butuhkan?"

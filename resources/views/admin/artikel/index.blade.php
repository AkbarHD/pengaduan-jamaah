                        ...
                        <div class="card-header border-light justify-content-between">
                            <div class="d-flex gap-2">
                                <div class="app-search">
                                    <input data-table-search type="search" class="form-control" placeholder="Cari artikel...">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            @if ($artikel->thumbnail)
                                                                <img src="{{ asset('uploads/artikel-thumbnail/' . $artikel->thumbnail) }}"
                                                                     alt="{{ $artikel->judul }}" class="rounded" style="width: 48px; height: 48px; object-fit: cover;">
                                                            @else
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="judul" href="#" class="link-reset">{{ $artikel->judul }}</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.artikel.download', $artikel) }}" class="badge badge-soft-success fs-xxs">
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-muted">{{ $artikel->updated_at->format('H:i') }}</small>
                                                </td>
                                                <td>

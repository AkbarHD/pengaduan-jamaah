<header class="site-navbar">
    <nav class="navbar navbar-expand-lg py-0">
        <div class="container">
            ...
            <button class="navbar-toggler site-toggler d-lg-none" type="button" data-bs-toggle="collapse"
                data-bs-target="#siteNavbarCollapse" aria-controls="siteNavbarCollapse" aria-expanded="false"

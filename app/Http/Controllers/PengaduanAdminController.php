    ...
    public function updateStatus(Request $request, Pengaduan $pengaduan)
{
    ...
    /*
    |--------------------------------------------------------------------------
    | NONAKTIF SEMENTARA: Notifikasi otomatis via Fonnte ke admin saat
    | pengaduan darurat baru terverifikasi.
    |
    | Alasan: untuk saat ini proses "teruskan ke KJRI" dilakukan manual
    | oleh admin lewat tombol WhatsApp di halaman detail (lihat method
    | forwardKjri di bawah), bukan otomatis via Fonnte.
    |
    | Kalau nanti mau diaktifkan lagi, tinggal un-comment blok ini.
    |--------------------------------------------------------------------------
    |
...
public function forwardKjri(Pengaduan $pengaduan)
{
    ...
    $nomorKjri = config('services.kjri.whatsapp');
    ...
    $pesan = "Assalamu'alaikum, kami menyampaikan pengaduan darurat jamaah:\n\n"
        ...
        . "Kategori: {$pengaduan->kategori_label}\n"
